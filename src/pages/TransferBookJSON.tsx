            ...
            {(() => {
                ...
                if (role == 'librarian') {
                    return <div style={{ textAlign: 'left', width: '1200px' }}>
                        ...
                        {buttonPressed=='false'?<button className="navbarbutton" onClick={() => transfer()}>Выдать все книги</button>:<button disabled id="backbutton">Выполнено</button>}<br /><br />
...
export default observer(TransferBookJSON)