                        ...
                        <div id="inventoryReceiptTable">
                            ...
                            <table style={{ borderCollapse: 'collapse' }}>
                                ...
                                <tr id="IRTableTR">
                                    ...
                                    <td id="IRTableText">Аттестат или диплом об образовании с приложением (подлинник и копия) или диплом об окончании ТиПО (подлинник и копия) <br />№ {inventoryData?.certificate_serial != '' ? inventoryData?.certificate_serial : inventoryData?.alternative_certificate_serial ? inventoryData?.alternative_certificate_serial:'_______'} {inventoryData?.certificate_number != '' ? inventoryData?.certificate_number : inventoryData?.alternative_certificate_number ? inventoryData?.alternative_certificate_number:'______________'} от {inventoryData?.alternative_certificate_date!='' ? moment(inventoryData?.alternative_certificate_date).format("LL") :  moment(inventoryData?.certificate_date).format("LL")}</td>
                                    <td id="IRTableBlank"></td>
                                    <td id="IRTableNumber">2</td>
                                    <td id="IRTableText">Аттестат или диплом об образовании с приложением (подлинник и копия) или диплом об окончании ТиПО (подлинник и копия) <br />№ {inventoryData?.certificate_serial != '' ? inventoryData?.certificate_serial : inventoryData?.alternative_certificate_serial ? inventoryData?.alternative_certificate_serial:'_______'} {inventoryData?.certificate_number != '' ? inventoryData?.certificate_number : inventoryData?.alternative_certificate_number ? inventoryData?.alternative_certificate_number:'______________'} от {inventoryData?.alternative_certificate_date!='' ? moment(inventoryData?.alternative_certificate_date).format("LL") :  moment(inventoryData?.certificate_date).format("LL")}</td>
                                    <td id="IRTableBlank"></td>
