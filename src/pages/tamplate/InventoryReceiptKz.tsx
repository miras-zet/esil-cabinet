...
export function InventoryReceiptKz() {
    ...
    return (
        <>
            <div>
                <Link to="/applicants"><button>Назад</button></Link>
