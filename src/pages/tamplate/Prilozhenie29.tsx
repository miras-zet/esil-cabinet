  ...
  return (
    ...
    <div id="report" style={{width: "100%", backgroundColor: 'white', color: "black"}}>
        ...
        <div className="shapka" >
				<p>
                Приложение 29<br/>
                К Правилам назначения, и осуществления <br/>
                выплаты государственного пособия на <br/>
                рождение, пособия по уходу, пособия <br/>
                многодетным семьям, пособия <br/>
                награжденной матери <br/>
