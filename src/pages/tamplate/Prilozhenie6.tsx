...
export function Prilozhenie6(certificat:CertResponse)  {
  ...
  return (
    ...
    <div id="report">
        ...
        <div className="shapka" >
				<p>
                    Приложение 6<br/>к Правилам назначения, предоставления государственной
                    <br/>
                    базовой пенсионной выплаты
                    <br/>
                    за счет бюджетных средств, а также
                    <br/>
                    назначения и осуществления
                    <br/>пенсионных выплат по
                    <br/>возрасту, государственных
                    <br/>социальных пособий по инвалидности<br/>
                    по случаю потери кормильца,
                    <br/>государственных специальных
                    <br/>пособий
                </p>
			</div>
            ...
            <div style={{
				...
				<div style={{
					...
					<div className="bodytext">
						...
						Примечание: справка действительна 1 год.<br/>
