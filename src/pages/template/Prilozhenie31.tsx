...
export function Prilozhenie31(certificat:CertResponse)  {
  ...
  return (
    ...
    <div id="report">
        ...
        <div className="shapka" >
				<p>
                Приложение 31<br/>
                к Правилам исчисления (определения), размеров<br/>
                социальных выплат, назначения, перерасчета,<br/>
                приостановления, возобновления, прекращения и<br/>
                осуществления социальных выплат из<br/>
                Государственного фонда социального<br/>
                страхования и их осуществления<br/>
 <br/>
