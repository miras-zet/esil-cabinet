...
export function Prilozhenie29Certif(certificat:CertResponse)  {
            ...
            <div style={{
				...
				<div style={{
					...
					<div className="bodytext">
                        ...
                        &nbsp;<u><b>Учреждение "Esil University" лицензия № KZ08LAA00032358  от 01.04.2022 г., без ограничения</b></u><br/> 
