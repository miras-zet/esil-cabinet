...
export function Prilozhenie2New(certificat:CertResponse)  {
            ...
            <div style={{
				...
				<div style={{
					...
					<div className="bodytext">
						...
						с {moment(certificat?.start_date).format("DD.MM.YYYY")} года по 30.06.{2025+certificat!.course_count-certificat!.course_number} года. <br/>
